...
```bash
git clone https://github.com/samirxnova/XRPrompt.git
cd XRPrompt
```
...
<details>
<summary><strong>💸 Basic Transactions</strong></summary>

<br>

```
✅ Send 15.5 XRP to rN7n7otELRKCpo4KJkNgSfCxp4oTajWjZn
✅ Transfer 100 XRP to rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY  
✅ Pay 25 XRP to rUCzEr6jrEyMpjhs4wSdQdz4g8Y382NxfM
✅ Move 50.75 XRP to destination rDNa4f8dJxp3fBdqjRQjKKHRthh2X7MoNr
```

</details>

<details>
<summary><strong>🏷️ Transactions with Destination Tags</strong></summary>

<br>

```
✅ Send 50 XRP to rDNa4f8dJxp3fBdqjRQjKKHRthh2X7MoNr with tag 12345
✅ Transfer 75 XRP to rLNaPoKeeBjZe2qs6x52yVPZpZ8td4dc6w destination tag 98765
✅ Pay 30 XRP to rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh tag 555
```

</details>

<details>
<summary><strong>📝 Transactions with Memos</strong></summary>

<br>

```
✅ Pay 30 XRP to rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh with memo "Invoice #1234"
✅ Send 20 XRP to rN7n7otELRKCpo4KJkNgSfCxp4oTajWjZn memo Payment for services
✅ Transfer 45 XRP to rPEPPER7kfTD9w2To4CQk6UCfuHM9c6GDY note "Monthly subscription"
```

</details>

<details>
<summary><strong>📊 Information Commands</strong></summary>
...
<details>
<summary><strong>🔽 Wallet Management Functions</strong></summary>

<br>

```javascript
// Create new XRP wallet with testnet funding
async function createWallet()

// Connect existing wallet using seed phrase  
async function connectWallet()

// Safely disconnect current wallet session
async function disconnectWallet()

// Update wallet UI components and balance
async function updateWalletUI()

// Refresh account balance from ledger
...
```javascript
// Parse natural language input into transaction object
function parseTransaction(userInput)

// Display transaction confirmation modal
function showTransactionPreview(transactionData)

// Execute confirmed transaction on XRP Ledger
...
```javascript
// Fetch and display detailed account information
...
> **🚨 TESTNET ONLY**: This application is designed exclusively for XRP Ledger Testnet. Never use mainnet credentials or real XRP without proper security audits.
...
:root {
  ...
  /* Accent Colors */
  --accent-primary: #00ff88;    /* Signature green */
  --accent-secondary: #00cc6a;  /* Darker green */
  --accent-tertiary: #00aa55;   /* Deep green */
...
<details>
<summary><strong>🔽 Major Features Planned</strong></summary>

<br>

- [ ] **Multi-Currency Support** - Support for IOU tokens and other assets
- [ ] **Advanced Transaction Scheduling** - Set up recurring and delayed payments  
- [ ] **Portfolio Analytics** - Comprehensive tracking and reporting
...
- [ ] **DeFi Integration** - AMM and DEX functionality
- [ ] **NFT Transaction Support** - Buy, sell, and transfer NFTs
- [ ] **Advanced Charting** - Technical analysis tools
- [ ] **Social Features** - Transaction sharing and community
